...
void NCPA::configure_epade_pe_parameter_set( NCPA::ParameterSet *ps ) {
	...
	ps->addParameterDescription( "Modes of Operation", "--multiprop", "Multiple azimuth propagation.  Requires --azimuth_start, --azimuth_end, and --azimuth_step, disables --atmosfile2d" );
